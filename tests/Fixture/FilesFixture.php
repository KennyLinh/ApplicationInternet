...
class FilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'path' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'product' => '', 'precision' => null, 'fixed' => null],
        ...
        'status' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'product' => '1 = Active, 0 = Inactive', 'precision' => null],
        '_constraints' => [
