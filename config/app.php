...
return [
     ...
     *      /.htaccess
     *      /webroot/.htaccess
     *   And unproduct the baseUrl key below.
    ...
    'Datasources' => [
        'default' => [
             ...
             * MySQL on MAMP uses port 8889, MAMP users will want to unproduct
            ...
            /*
             * During development, if using MySQL < 5.6, unproducting the
